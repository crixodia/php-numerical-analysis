...
<head>
    ...
    <title>Algoritmo de Thomas</title>
        ...
        <div class="container pdtop maxwidth-700">
            ...
            <div class="accordion" id="accordion_' . $i . '">
                <div class="card bg-light">
                    <h5 class="card-header" style="background-color: #e7f1ff;"><a href="index.php"><img src="assets/left.png" width="24px"></a> Algoritmo de Thomas</h5>
                    <div class="card-body">
                        <form action="thomas.php" method="GET" class="font-monospace">
