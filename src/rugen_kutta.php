...
<head>
    ...
    <title>EDO Método de cuarto orden</title>
    ...
    <div class="container">
        <div class="container pdtop maxwidth-900">
            <div class="accordion" id="accordion_' . $i . '">
                <div class="card bg-light">
                    <h5 class="card-header" style="background-color: #e7f1ff;"><a href="index.php"><img src="assets/left.png" width="24px"></a> EDO Método de cuarto orden</h5>
                    <div class="card-body">
                        <form action="rugen_kutta.php" enctype="multipart/form-data" method="GET" class="font-monospace">
        ...
        <div class="container pdtop text-break maxwidth-900">
            ...
            if (!empty($_GET)) {
                ...
                list($ans_x, $ans_y) = fourth_order($x, $y, ($b - $a) / $n, $n, $f);
