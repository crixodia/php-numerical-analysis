...
<body>
    ...
    <div class="container">
        ...
        <div class="container pdtop maxwidth-700">
            ...
            <div class="accordion" id="accordion_' . $i . '">
                <div class="card bg-light">
                    <h5 class="card-header" style="background-color: #e7f1ff;">Eliminación Guassiana y Descomposición LU</h5>
                    <div class="card-body">
        ...
        <h6 class="text-center text-muted pdtop">Tarea 8 - Cristian Bastidas</h6>
