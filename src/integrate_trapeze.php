    ...
    <div class="container">
                ...
                <div class="card-body">
                    <form action="./integrate_trapeze.php" method="GET" class="font-monospace">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input id="tolerancia" name="tolerancia" placeholder="0.00001" value=<?php if (!empty($_GET)) {
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input id="n_inicial" name="n_inicial" placeholder="10" value=<?php if (!empty($_GET)) {
                                                                                                            echo $_GET["n_inicial"];
                                                                                                        } else {
                                                                                                            echo "10";
                                                                                                        } ?> type="number" step="any" aria-describedby="deltaHelpBlock" required="required" class="form-control">
                        ...
                        <div class="m-0" style="padding-top: 10px;">
                            <button name="submit" type="submit" class="btn btn-warning">Calcular</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="container pdtop maxwidth-700">
            ...
            if (!empty($_GET)) {
                ...
                $table = i_iterative_trapecio($funcion, $_GET["limite_a"], $_GET["limite_b"], $_GET["tolerancia"], $_GET["n_inicial"]);
            ...
            ?>
                <div class="pdbot">
                    <div class="card bg-light">
                        <div class="card-header" style="background-color: #fff3cd;">Valores</div>
                        <div class="card-body">
                            <div class="row">
        ...
        <?php
                ...
                foreach ($title as $head) {
                    echo "<th scope='col' class='text-center table-warning'>" . $head . "</th>";
                }
                echo '</thead>';
                $counter = 0;
                foreach ($table as $line) {
                    ...
                    foreach ($line as $value) {
                        if ($counter == 0) {
                            echo "<th class='text-center table-warning' scope ='row'>" . $value . "</th>";
                        } else {
