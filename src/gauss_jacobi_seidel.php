        ...
        <div class="container pdtop maxwidth-700">
            ...
            <div class="accordion" id="accordion_' . $i . '">
                <div class="card bg-light">
                    <h5 class="card-header" style="background-color: #e7f1ff;"><a href="index.php"><img src="assets/left.png" width="24px"></a> Gauss-Jacobi y Gauss-Seidel</h5>
                    <div class="card-body">
                        <form action="gauss_jacobi_seidel.php" method="GET" class="font-monospace">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <select class="form-select" name="metodo" aria-label="Default select example">
                                            ...
                                            <option value="0" <?php echo $values[0] ?>>Jacobi</option>
            ...
            <div class="container pdtop maxwidth-900">
                ...
                if (!empty($_GET)) {
                    ...
                    $init = array_fill(0, count($b), 1);
                    $x = $_GET["metodo"] == 0 ? gauss_jacobi_iterative($A, $b, $init, $_GET["tolerancia"], $_GET["n_max"]) : gauss_seidel_iterative($A, $b, $init, $_GET["tolerancia"], $_GET["n_max"]);
                    $table = $_GET["metodo"] == 0 ? gauss_jacobi_iterative($A, $b, $init, $_GET["tolerancia"], $_GET["n_max"], true) : gauss_seidel_iterative($A, $b, $init, $_GET["tolerancia"], $_GET["n_max"], true);
