...
<head>
    ...
    <title>Cambio de signos y Bisección - Cristian Bastidas</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container pdtop maxwidth-700">
            <div class="card bg-light">
                <h5 class="card-header" style="background-color: #e7f1ff;">Búsqueda de Raíces (Bisección)</h5>
    ...
    <h6 class="text-center text-muted pdtop">Tarea 4 - Cristian Bastidas</h6>
</body>
