...
<head>
    ...
    <title>Búsqueda de raíces: Secante, Bisección, Newton-Raphson</title>
    ...
    <div class="container">
        ...
        <div class="container pdtop maxwidth-700">
            <div class="card bg-light">
                <h5 class="card-header" style="background-color: #e7f1ff;"><a href="index.php"><img src="assets/left.png" width="24px"></a> Búsqueda de raíces: Secante, Bisección, Newton-Raphson</h5>

                <div class="card-body">
                    <form action="secant.php" method="GET" class="font-monospace">
