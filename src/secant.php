...
<head>
    ...
    <title>Búsqueda de raíces - Cristian Bastidas</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container pdtop maxwidth-700">
            <div class="card bg-light">
                <h5 class="card-header" style="background-color: #e7f1ff;">Búsqueda de Raíces</h5>
    ...
    <h6 class="text-center text-muted pdtop">Tarea 6 - Cristian Bastidas</h6>
</body>
